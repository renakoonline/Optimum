...
<div class="admin">
	...
	<thead>
		<tr>
			<th><h1>Welcome Admin, <%=refUser.getFname()%></h1></th>
		</tr>
	</thead>
	<tbody>
		<tr>
			<td><a href="Registration.jsp" target="iframe1">Register New User</a>
		</td>
		</tr>
		<tr>
			<td><a href="ViewUserList.jsp" target="iframe1">View User List</a>
		</td>
		</tr>
		<tr>
			<td><a href="UpdateLock.jsp" target="iframe1">Lock/Unlock User</a></td>
		</tr>
		<tr>
...
<div>
<iframe class="frame" name="iframe1"></iframe>
</div>
